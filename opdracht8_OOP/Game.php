...
class Game {
    ...
    public function __construct($diceCount, $numberOfPlayers = 2) {
        $this->players = range(1, $numberOfPlayers);
        $this->dice = array();
        $this->throwCount = 0;
    ...
    public function play() {
        foreach ($this->players as $player) {
            $this->throwCount++;
            echo "Speler $player, Worp " . $this->throwCount . ": ";
            $results = array();
            ...
            echo "Totaalscore voor Speler $player: $totalScore<br/>";
